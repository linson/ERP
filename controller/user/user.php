...
class ControllerUserUser extends Controller {  
  ...
  public function changepassword(){
		$this->template = 'user/changepassword.tpl';
  ...
  public function updatepassword(){
    //$this->log->aPrint( $this->request->post ); exit;
 		$this->load->model('user/user');
   	$this->model_user_user->updatepassword($this->request->post);
  ...
  private function getList() {
	...
	private function getForm() {
    	...
    	$this->data['tab_general'] = $this->language->get('tab_general');
	 	...
	 	isset($this->error['lastname']) ? $this->data['error_lastname'] = $this->error['lastname'] : $this->data['error_lastname'] = '';
    ...
    if (isset($this->request->post['email'])) {
  	...
  	isset($user_info) ? $this->data['approver'] = $user_info['approver'] : $this->data['approver'] = '';
