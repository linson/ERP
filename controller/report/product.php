...
class ControllerReportProduct extends Controller{
    ...
    $filter_to     = $this->util->parseRequest('filter_to','get',date("Y-m-t",strtotime("0 month")));
		...
		$res = $this->model_report_sale->stat_product($req);
		//$this->log->aPrint( $res );
    ...
    $this->data['pday_label'] = $pday_label;
		$this->data['lnk_pday'] = HTTPS_SERVER . 'index.php?route=report/product&filter_from=' . $pday_from . '&filter_to=' . $pday_to;

    $tday_label = date('m-d(D)',strtotime("0 month"));
    $tday_from = $tday_to = date('Y-m-d',strtotime("0 month"));
    $this->data['tday_label'] = $tday_label;
		$this->data['lnk_tday'] = HTTPS_SERVER . 'index.php?route=report/product&filter_from=' . $tday_from . '&filter_to=' . $tday_to;
    ...
    $this->data['pmonth_label'] = $pmonth_label;
		$this->data['lnk_pmonth'] = HTTPS_SERVER . 'index.php?route=report/product&filter_from=' . $pmonth_from . '&filter_to=' . $pmonth_to;
    ...
    $this->data['tmonth_label'] = $tmonth_label;
		$this->data['lnk_tmonth'] = HTTPS_SERVER . 'index.php?route=report/product&filter_from=' . $tmonth_from . '&filter_to=' . $tmonth_to;
    ...
    $this->data['nmonth_label'] = $nmonth_label;
		$this->data['lnk_nmonth'] = HTTPS_SERVER . 'index.php?route=report/product&filter_from=' . $nmonth_from . '&filter_to=' . $nmonth_to;
    ...
    $this->data['pquarter_label'] = $pquarter_label;
		$this->data['lnk_pquarter'] = HTTPS_SERVER . 'index.php?route=report/product&filter_from=' . $pquarter_from . '&filter_to=' . $pquarter_to;
    ...
    ***/
    ...
    $group       = $this->util->parseRequest('group','get','');
		...
		$res = $this->model_report_sale->ordersales($req);
