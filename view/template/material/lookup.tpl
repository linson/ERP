        ...
        ?>
          <tr class="filter">
            <td class='left' colspan=2>
              <input type="text" name="filter_desc" value="<?php echo $filter_desc; ?>" />
            </td>
            ...
            <td>
              <select name="filter_status">
                <option value=""  <?php if(''==$filter_status) echo 'selected'; ?>>--</option>
                <option value="0" <?php if('0'==$filter_status) echo 'selected'; ?>>UNUSE</option>
                <option value="1" <?php if('1'==$filter_status) echo 'selected'; ?>>INUSE</option>
                <option value="2" <?php if('2'==$filter_status) echo 'selected'; ?>>INACTIVE</option>
              </select>
            </td>
          ...
          <tr>
            ...
            <td class="left"><?php echo $package['code']; ?></td>
...
$(document).ready(function(){
  ...
  filter = function(){
  	...
  	var filter_desc = $('input[name=\'filter_desc\']').attr('value');
  	if(filter_desc) url += '&filter_desc=' + encodeURIComponent(filter_desc);
