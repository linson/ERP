...
<div class="box">
  ...
  <div id="ubporder">
            ...
            <table style='width:200px' id='cpay'>
              <tr>
                ...
                <td style='border-left:1px dotted #e9e9e9;'>
                  <input type=number name='post_check' style='width:60px' value='<?php echo $post_check ?>' />
                </td>
              </tr>
              <tr>
                <td>Current Check</td>
                <td>
                  <input type=number name='cur_check'  style='width:60px' value='<?php echo $cur_check ?>' />
                </td>
              </tr>
              <tr>
                <td>Current Cash</td>
                <td>
                  <input type=number name='cur_cash'   style='width:60px' value='<?php echo $cur_cash ?>' />
                </td>
              </tr>
            </table>
          </div>
    ...
    <!-- order info -->
    <div id='order'>
      <?php require_once('view/template/sales/sales_debug.tpl'); ?>
    </div>
  </div>
  </form>
  <div class='footer'>
...
<script type='text/javascript' src='view/template/sales/order_debug.js'></script>