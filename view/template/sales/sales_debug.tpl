    ...
    <table id='<?php echo $key; ?>' sibling='<?php echo $sibling; ?>' style='display:block'>
      ...
      ?>
        ...
        <div class='item'>
         ...
         <div style='margin-left:5px'>
          <input type='text' class='total_price' name='total_price[]' value='<?php echo $row['total_price']; ?>' style='width:35px;background-color:#e2e2e2;' readonly />
          <input type='hidden' name='weight_row[]' value='<?php echo $row['weight_row']; ?>'/></div>
         <div>
          <input type='text' name='stock[]' value='<?php echo $row['quantity']; ?>' style='width:25px' class='check_locked np' readonly/>
         </div>
  ...
  $.fn.retrieveGroup = function($exceptNode,$model){
    ...
    $.ajax({
        ...
        var node = $exceptNode,
            ...
            $itemHtml+= " <div style='margin-left:5px'><input type='text' class='total_price' name='total_price[]' value='0.00' style='width:35px' readonly /><input type='hidden' name='weight_row[]' value=''/></div>";
            $itemHtml+= " <div><input type='text' name='stock[]' value='stock' style='width:25px' class='check_locked' readonly/></div>";
