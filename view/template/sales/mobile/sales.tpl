      ...
      ?>
        ...
        <div class='item'>
         ...
         <div class='model'>
           ...
           <input type='text' name='model_show[]' value='<?php echo substr($row['model'],2,4); ?>' class='model_show' style='width:40px' readonly /></div>
         <div><input type='text' name='price[]' value='<?php echo $price; ?>' style='width:36px' /></div>
         <div><input type='number' name='cnt[]' value='<?php echo $row['cnt']; ?>' style='width:30px;background-color:#66ff00;' /></div>
         <div>
          <input type='text' name='free[]' value='<?php echo $row['free']; ?>' style='width:20px;background-color:#ffcc00;' /></div>
         <div><input type='text' name='damage[]' value='<?php echo $row['damage']; ?>' style='width:20px' /></div>
         <div>
          <input type='text' name='promotion[]' value='<?php echo $row['promotion']; ?>' style='width:20px' />
          <input type='text' name='pkg[]' value='<?php echo ( $row['cnt'] + $row['free'] + $row['damage'] + $row['promotion'] ) ?>' style='display:none;' />
         </div>
         <div style='margin-left:5px'>
          <input type='text' name='discount[]' value='<?php echo $row['dc1']; ?>'  style='width:20px;background-color:#ffff99;' /></div>
         <div><input type='text' name='discount2[]' value='<?php echo $row['dc2']; ?>' style='width:20px;background-color:#ffff99;' /></div>
         <div style='margin-left:5px'>
  ...
  $.fn.retrieveGroup = function($exceptNode,$model){
    ...
    $.ajax({
        ...
        var node = $exceptNode,
            ...
            $itemHtml+= "   <input type='text' name='model_show[]' style='width:40px' value=''  readonly /></div>";
            $itemHtml+= " <div><input type='text' name='price[]' value='price' style='width:36px' /></div>";
            $itemHtml+= " <div><input type='number' name='cnt[]' value='0' style='width:30px;background-color:#FFFF99;' /></div>";
            $itemHtml+= " <div><input type='text' name='free[]' value='free' style='width:20px'  /></div>";
            $itemHtml+= " <div><input type='text' name='damage[]' value='dmg' style='width:20px'  /></div>";
            $itemHtml+= " <div><input type='text' name='promotion[]' value='pr' style='width:22px'  /><input type='text' name='pkg[]' value='' style='display:none;' /></div>";
            $itemHtml+= " <div style='margin-left:5px'><input type='text' name='discount[]' value='d1' style='width:20px;' /></div>";
            $itemHtml+= " <div><input type='text' name='discount2[]' value='d2' style='width:20px;' /></div>";
            ...
            $itemHtml+= " <div style='display:none'><input type='text' name='stock[]' value='stock' style='width:30px'  class='check_locked' /></div>";
