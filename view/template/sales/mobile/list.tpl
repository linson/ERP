      ...
      <table class="list">
        ...
        <tbody>
          <tr class="filter">
            ...
            <td>
              <select id="filter_approve_status">
            		...
            		<option value="approve" <?php echo 'approve' == $filter_approve_status ? "selected='selected'" : ""; ?>>Approve</option>
            		<option value="pending" <?php echo 'pending' == $filter_approve_status ? "selected='selected'" : ""; ?>>Pending</option>
            	</select>
            </td>
            <td>
              <!-- status -->
          ...
          <tr <?php echo $bg_css?>>
            ...
            <td class="left"><input type=text name=shipped_yn value=<?php echo $tx['shipped_yn'] ?> size=1 /></td>
  ...
  $.fn.filter = function(){
    ...
    var filter_txid = $('input[name=\'filter_txid\']').attr('value');
  	...
  	if(filter_order_price){
  		url += '&filter_order_price=' + encodeURIComponent(filter_order_price);
  	}
  	...
  	if(filter_payed != '*'){
  		url += '&filter_payed=' + encodeURIComponent(filter_payed);
  	}
  	...
  	if(filter_approve_status != ''){
  		url += '&filter_approve_status=' + encodeURIComponent(filter_approve_status);
  	}
  	location = url;
  }
