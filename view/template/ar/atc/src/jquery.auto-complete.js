...
var
	...
	AutoComplete = $.autoComplete = {
		...
		defaults: {
			...
			// Server Script Path
			ajax: 'view/template/ar/atc/ajax.php',
	...
	AutoCompleteFunction = function( self, options ) {
        ...
        **/
          ...
          /* i will use keydown event for lookup ajax , besso */
...
*/
      ...
      // besso
		...
		function newUl() {
			...
			if ( $ul.data( 'autoComplete' ) !== TRUE ) {
				...
				.bind( 'click.autoComplete', function( event ) {  // besso
	  				AutoComplete.getFocus( TRUE ).trigger( 'autoComplete.ul-click', [ event ] );
  					//return FALSE;
				})
    ...
    function callCustom(accountno){
      accountno = accountno.trim();
			location.href = 'index.php?route=ar/detail&accountno=' + accountno;
    }
