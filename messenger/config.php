...
$dbss['user']='messenger';                  // database user (not used with sqlite)
$dbss['pass']='1111';                  // database password  (not used with sqlite)
$dbss['name']='messenger';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
